        ...
        <div className="w-[30%]">
          <div className=" w-full flex justify-center h-screen items-center relative">
            <div className="w-[80%] h-[90%] gap-2 flex flex-col relative items-center border-r-2">
              <h2 className="text-[24px] font-bold flex items-center mt-7">
                Profile
              </h2>
              <div className="flex justify-center flex-col gap-2 relative items-center">
                ...
                <div className="flex justify-center items-center flex-col">
                  ...
                  <p className="text-[18px] text-center mt-2">
                    ...
                    elit,quat.Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit,quat.Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit,quat.
                  </p>
                </div>
        ...
        <div className="w-[70%]">
          <div className="w-full h-full">
            <div className="flex w-full mt-12">
              <div className="w-[70%]">
                <h2 className="font-bold text[18px] mx-[15px] mt-2">
                  Basic Info
                </h2>
              </div>
