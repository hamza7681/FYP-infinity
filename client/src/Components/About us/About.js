      ...
      <div className="flex lg:flex-row flex-col px-[20px] md:px-16 w-auto gap-x-40 mt-8">
        <div className="lg:w-2/4 md:w-2/4 w-full ">
          ...
          <p className="w-full py-[5px] text-[15px] mt-3 text-justify">
            ...
            courses at one platform.</p>
            <p className="w-full py-[5px] text-[15px] mt-3 text-justify">The courses are tailored to suit learners' needs, whether they are
            beginners or advanced learners. The website offers a wide range of courses in each language, covering different aspects of language learning,
            including game development, web development, IOT and lot more. The courses are delivered in a variety of formats,
            including video lectures, interactive exercises, and quizzes, which make learning engaging and enjoyable.
            They can access the courses anytime, anywhere, and on any device, making learning flexible and convenient.
          </p>
