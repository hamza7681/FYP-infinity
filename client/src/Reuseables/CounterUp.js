...
const CounterUp = () => {
  const [counters, setCounters] = useState([
    ...
    { icon: <FaChalkboardTeacher className="text-white" />, count: 0, text: 'Tutors' },
    { icon: <FaBuilding className="text-white" />, count: 0, text: 'Languages' },
    { icon: <FaGraduationCap className="text-white" />, count: 0, text: 'Courses' },
  ]);
  ...
  return (
    <div className="flex lg:flex-row w-full flex-col  lg:72 h-auto justify-center mt-20 mb-20 bg-blue-700">
